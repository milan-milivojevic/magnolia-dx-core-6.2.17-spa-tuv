...
function Accordion ({
  ...
  const itemStyles = {
    ...
    borderBottomWidth: accordionBorderWidth || configProps?.accordionBorderWidth || null,
    borderBottomStyle: accordionBorderStyle || configProps?.accordionBorderStyle || null,
    borderBottomColor: accordionBorderColor || configProps?.accordionBorderColor || null,
    borderBottomRadius: accordionBorderRadius || configProps?.accordionBorderRadius || null,
