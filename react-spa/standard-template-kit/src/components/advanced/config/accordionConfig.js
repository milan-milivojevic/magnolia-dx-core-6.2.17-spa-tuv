...
function Accordion ({
  ...
  const itemStyles = {
    ...
    borderBottomWidth: accordionBorderWidth || null,
    borderBottomStyle: accordionBorderStyle || null,
    borderBottomColor: accordionBorderColor || null,
    borderBottomRadius: accordionBorderRadius || null,
    width: width || "100%"
  }
