...
function AccordionItem ({
  ...
  const accordionItemWrapperStyles = {
    ...
    borderBottomWidth: listProps[0].accordionBorderWidth || null,
    borderBottomStyle: listProps[0].accordionBorderStyle || null,
    borderBottomColor: listProps[0].accordionBorderColor || null,
    borderBottomRadius: listProps[0].accordionBorderRadius || null
  }
